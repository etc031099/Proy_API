        ...
        <div className="space-y-6">
          <FadeIn delay={0.1}>
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-3xl font-bold">{t('contacts.addTitle')}</h1>
                <p className="text-muted-foreground">{t('contacts.createSubtitle')}</p>
              </div>
            </div>
          </FadeIn>
                    ...
                    <FormFieldAnimation delay={0.6}>
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          >
                            {documentLoading ? t('contacts.lookingUp') : t('contacts.lookup')}
                          </Button>
                        </div>
                      </div>
                    </FormFieldAnimation>
                    ...
                    <FormFieldAnimation delay={0.8}>
                      <div className="space-y-2">
                        ...
                        <Textarea
                          id="notes"
                          name="notes"
                          placeholder={t('contacts.additionalNotes')}
